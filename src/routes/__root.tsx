...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vanta Beta" },
      { name: "description", content: "Vanta Beta — checkout automation dashboard and Windows desktop app." },
      { name: "author", content: "Vanta" },
      { property: "og:title", content: "Vanta Beta" },
      { property: "og:description", content: "Vanta Beta — checkout automation dashboard and Windows desktop app." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Vanta" },
      { name: "twitter:title", content: "Vanta Beta" },
      { name: "twitter:description", content: "Vanta Beta — checkout automation dashboard and Windows desktop app." },
